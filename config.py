...
_DEFAULT_DELAY = float(_get_env("CHAT_DEFAULT_DELAY", "30"))
...
_DEFAULT_TEMPERATURE = float(_get_env("CHAT_DEFAULT_TEMPERATURE", "1.0"))
_DEFAULT_MAX_COMPLETION_TOKENS = int(_get_env("CHAT_DEFAULT_MAX_COMPLETION_TOKENS", "256"))
